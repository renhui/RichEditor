...
import com.frame.imageloader.cache.disc.DiskCache;
import com.frame.imageloader.cache.disc.naming.FileNameGenerator;
import com.frame.imageloader.cache.memory.MemoryCache;
import com.frame.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.frame.imageloader.core.assist.FlushedInputStream;
import com.frame.imageloader.core.assist.ImageSize;
import com.frame.imageloader.core.assist.QueueProcessingType;
import com.frame.imageloader.core.decode.ImageDecoder;
import com.frame.imageloader.core.download.ImageDownloader;
import com.frame.imageloader.core.process.BitmapProcessor;
import com.frame.imageloader.utils.L;
import com.frame.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.frame.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.frame.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.frame.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.frame.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.frame.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.frame.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.frame.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.frame.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.frame.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.frame.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.frame.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.frame.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.frame.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.frame.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
