...
import com.frame.imageloader.core.imageaware.ImageViewAware;
import com.frame.imageloader.core.imageaware.NonViewAware;
import com.frame.imageloader.core.listener.ImageLoadingListener;
import com.frame.imageloader.core.listener.ImageLoadingProgressListener;
import com.frame.imageloader.core.listener.SimpleImageLoadingListener;
import com.frame.imageloader.utils.ImageSizeUtils;
...
public class ImageLoader {
	 ...
	 * @param imageAware {@linkplain com.frame.imageloader.core.imageaware.ImageAware Image aware view}
	 ...
	 * @param imageAware {@linkplain com.frame.imageloader.core.imageaware.ImageAware Image aware view}
	 *                   which should display image
	 * @param options    {@linkplain com.frame.imageloader.core.DisplayImageOptions Options} for image
	 ...
	 * @param progressListener {@linkplain com.frame.imageloader.core.listener.ImageLoadingProgressListener
	 *                         Listener} for image loading progress. Listener fires events on UI thread if this method
	 *                         is called on UI thread. Caching on disk should be enabled in
	 *                         {@linkplain com.frame.imageloader.core.DisplayImageOptions options} to make
	 *                         this listener work.
	 * @throws IllegalStateException    if {@link #init(ImageLoaderConfiguration)} method wasn't called before
	 * @throws IllegalArgumentException if passed <b>imageAware</b> is null
	 */
	 ...
	 * {@link com.frame.imageloader.core.imageaware.ImageAware ImageAware}
	 */
	 ...
	 * {@link com.frame.imageloader.core.imageaware.ImageAware ImageAware}.
	 *
	 * @param imageAware {@link com.frame.imageloader.core.imageaware.ImageAware ImageAware} for
	 ...
	 * {@linkplain com.frame.imageloader.core.ImageLoaderConfiguration.Builder#taskExecutor(java.util.concurrent.Executor)
