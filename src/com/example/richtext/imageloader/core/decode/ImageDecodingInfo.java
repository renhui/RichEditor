 ...
 *******************************************************************************/
package com.example.richtext.imageloader.core.decode;
...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.example.richtext.imageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */
