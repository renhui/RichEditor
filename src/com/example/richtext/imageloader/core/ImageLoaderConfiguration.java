...
import com.example.richtext.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.example.richtext.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.example.richtext.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * {@link com.example.richtext.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache} will be used as
		 ...
		 * Default value - {@link com.example.richtext.imageloader.cache.memory.impl.LruMemoryCache LruMemoryCache}
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.example.richtext.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.example.richtext.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.example.richtext.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		 ...
		 * Default value - {@link com.example.richtext.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.example.richtext.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.example.richtext.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.example.richtext.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
	 ...
	 * using {@link com.example.richtext.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
